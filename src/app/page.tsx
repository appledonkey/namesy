...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Main: Name preview area (placeholder for now) */}
      {step === "main" && (
        <main className="max-w-4xl mx-auto px-6 py-8">
          <div className="text-center">
            <p className="text-muted">Main preview area coming next...</p>
            <p className="text-muted text-sm mt-2">Last name: {lastName}</p>
          </div>
        </main>
      )}
    </div>

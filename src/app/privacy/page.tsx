    ...
    <main className="min-h-screen bg-background py-12 px-4">
      <article className="max-w-2xl mx-auto prose prose-neutral dark:prose-invert">
        ...
        <section className="space-y-6">
          <div>
            <h2 className="text-xl font-heading font-semibold text-foreground mb-2">Overview</h2>
          ...
          <div>
            <h2 className="text-xl font-heading font-semibold text-foreground mb-2">Data Collection</h2>
          ...
          <div>
            <h2 className="text-xl font-heading font-semibold text-foreground mb-2">Local Storage</h2>
            <p className="text-foreground/80">
          ...
          <div>
            <h2 className="text-xl font-heading font-semibold text-foreground mb-2">Offline Functionality</h2>
            <p className="text-foreground/80">
          ...
          <div>
            <h2 className="text-xl font-heading font-semibold text-foreground mb-2">Children&apos;s Privacy</h2>
            <p className="text-foreground/80">
          ...
          <div>
            <h2 className="text-xl font-heading font-semibold text-foreground mb-2">Changes to This Policy</h2>
            <p className="text-foreground/80">
          ...
          <div>
            <h2 className="text-xl font-heading font-semibold text-foreground mb-2">Contact</h2>
            <p className="text-foreground/80">
